...
static const char *searchcmd[] = { "st", "-e", "tmux", "new-session", "browser searx.strus.guru", NULL };
static const char *bukucmd[] = { "st", "-e", "tmux", "new-session", "buku", NULL };
static const char *calccmd[] = { "st", "-n", "calculator", "-e", "qalc", NULL };
...
static Key keys[] = {
    ...
    { 0,        MODKEY,                       XK_KP_5, spawn,   {.v = mpctogglecmd } },
    { 0,        MODKEY,                       XK_KP_6, spawn,   {.v = mpcnextcmd } },
    { 0,        MODKEY,                       XK_KP_4, spawn,   {.v = mpcprevcmd } },
    ...
    { 0,        MODKEY|ShiftMask,             XK_c, spawn,               {.v = colorpicker } },
    TAGKEYS(                        XK_1,                      0)
    TAGKEYS(                        XK_2,                      1)
    TAGKEYS(                        XK_3,                      2)
    TAGKEYS(                        XK_4,                      3)
